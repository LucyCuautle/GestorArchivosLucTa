 ...
 */
public class VentanaEliminarIndicadorProcesoUsuario extends javax.swing.JFrame {

    private IndicadorProcesoUsuario ipu;

    public VentanaEliminarIndicadorProcesoUsuario(IndicadorProcesoUsuario ipu) {
        initComponents();
        this.ipu = ipu;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int opcion = JOptionPane.showConfirmDialog(null, "Al eliminar este indicador se borrara toda relacion con el proceso y el usuario seleccionado", "Advertencia", JOptionPane.WARNING_MESSAGE);

        if (opcion == JOptionPane.YES_OPTION) {
            Accion accion = new Accion();
            accion.setAccion(6);
            accion.setSubAccion(3);
            accion.setObject(ipu);
