 ...
 */
public class VentanaAgregarIndicadorProcesoUsuario extends javax.swing.JFrame {
    ...
    public VentanaAgregarIndicadorProcesoUsuario(UsuarioRegistro usuario, Proceso proceso) {
        initComponents();
    ...
    private void agregarIndicadorProcesoUsuario(Indicador indicador) {
        IndicadorProcesoUsuario indicadorProcesoUsuario = new IndicadorProcesoUsuario();
        indicadorProcesoUsuario.setIndicador(indicador);
        indicadorProcesoUsuario.setProceso(proceso);
        indicadorProcesoUsuario.setUsuarioRegistro(usuario);

        Accion accion = new Accion();
        accion.setAccion(11);
        accion.setObject(indicadorProcesoUsuario);
        Client c = new Client(IP, Util.PORT, 3, accion);//192.168.1.72
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (indicadorSeleccionado >= 0) {
            agregarIndicadorProcesoUsuario(indicadores.get(indicadorSeleccionado));
        } else {
